            ...
            <section className="main-content-section">
                ...
                <div className='header-div header-two'>
                    <div className='title-name'>
                        <h5>CAT Result</h5>
                        <p><a onClick={() => window.location.reload()} style={{cursor:"pointer", color:"#099ded"}}>Home</a> <i class="fa-solid fa-caret-right"></i>CAT Result</p>
                    </div>
                </div>

                <div className='take-assessment-container'>
                    <div className="title-text">
                        <h2>CAT <span style={{ fontWeight: "300" }}>Result Lists</span></h2>
                    </div> 

                    <div className='take-asessment-form'>
                        <div className='assessment-data'>
                            <h5>All available CAT</h5>
                                ...
                                catData.map((item, index) => (
                                    <div className='assessment-items' key={item._id}>
                                        ...
                                        <div className='assessment-actions' style={{display:"flex", justifyContent:"space-between"}}>
                                            ...
                                            <p onClick={() => navigate(`/cat-result/${item._id}`)} style={{marginBottom:"0px", cursor:"pointer", color:"#036bfc"}}>
