...
function TrainingCategory() {
  ...
  const Add_Training_Category = async () => {
    try {
      const resp = await axios.post(`${base_url}/api/lookup/SaveLookup`, {
        lookup_id: lookup_id ? lookup_id : null,
        lookup_type: "training_category",
        lookup_value: Training_Category.training_category,
      });
      if (resp.status === 200) {
        toast.success("Training Category Saved", { autoClose: 2000 });
      }
    } catch (error) {
      console.log(error);
    }
...
{
    setTraining_Category({...Training_Category,training_category:item.lookup_value})
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                value={Training_Category.training_category}
                onChange={(e) =>
                  setTraining_Category({
                    ...Training_Category,
