  ...
  />
      ...
      <div className="table-container">
        <table className="mapping-table">
          <thead>
            <tr>
              <th colSpan={2} className="employee-details-group">Employee details</th>
  <th colSpan={2} className="skills-category-group">Skills Category / Tags</th>
              <th>Define Skills level</th>
              <th>Assign Function</th>
              <th>Assign Job Profile</th>
              <th>Courses</th>
...
<th className="name-column">Employee Name</th>
  ...
  <button
   ...
   onClick={() => navigate(`/employeeCompetencymapping/${item.employeeId}`)}
